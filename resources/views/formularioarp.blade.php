            ...
            <p>No Questionário abaixo, você encontrará uma série de questões referentes às situações relacionadas ao trabalho. Para responder selecione uma das respostas que melhor represente sua opinião. <br>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Seu nome completo"
                        value="{{ isset($convite) && $convite ? $convite->colaborador->nome : '' }}" required>
                </div>

                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="text" class="form-control" id="email" name="email" placeholder="Seu email"
                        value="{{ isset($convite) && $convite ? $convite->colaborador->email : '' }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="departamento" name="departamento" placeholder="Departamento"
                        value="{{ isset($convite) && $convite ? ($convite->colaborador->setor ?? '') : '' }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="funcao" name="funcao" placeholder="Função"
                        value="{{ isset($convite) && $convite ? ($convite->colaborador->cargo ?? '') : '' }}" required>
                </div>
