...
@section('content')
 ...
 <div class="intro-y flex items-center mt-8 ">
    ...
    <div class="flex-wrap">
        ...
        <a href="{{ route('arp.colaboradores.index', $empresa->id) }}"class="btn btn-primary shadow-md mr-2" style="margin: 5px"><i data-feather="plus" class="w-4 h-4 mr-2"></i>
            Gerenciar Colaboradores ARP
          </a>
     </div>
    </div>
